...
<Callout title="Central idea" tone="proof">
  In BisQue, an image belongs to a scientific record that keeps storage, viewing, metadata, annotations, analysis, and reproducible outputs connected.
</Callout>
...
<FigureWithCaption
  ...
  caption="That dual identity matters. BisQue is both a tool people use and a system labs can deploy, extend, and build on."
/>
...
<FeatureGrid
  items={[
    ...
    },
    {
      ...
      body: "BisQue is built for the dimensional complexity of scientific imaging rather than flat image browsing alone.",
      metric: "up to 5D",
    },
    {
...
<FigureWithCaption
  ...
  caption="The interface shown in the docs is a scientific workspace where navigation, inspection, and context remain adjacent."
  span="measure"
/>
...
The clearer workflows, the emphasis on artifacts and provenance, and the run-control posture of the updated app all make more sense in light of the BisQue platform beneath them. BisQue Ultra is credible because it inherits real scientific foundations: storage at scale, multi-dimensional viewing, flexible metadata, annotations, modules, reproducible workflows, and a deployment story serious teams can actually use.
